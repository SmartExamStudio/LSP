...
public class FormTambahKaryawan extends JFrame {
    ...
    public FormTambahKaryawan(FormDataKaryawan parent) {
        this.parent = parent;
        setTitle("Tambah Data Karyawan - DistroZone");
        setSize(550, 750);
        ...
        JLabel lblTitle = new JLabel("➕ TAMBAH DATA KARYAWAN");
        ...
        btnSimpan.addActionListener(e -> verifikasiSimpan());
    ...
    private void simpanData() {
        try {
            ...
            String sql = "INSERT INTO tb_karyawan (nama, username, password, alamat, no_telepon, NIK, foto_karyawan) VALUES (?,?,?,?,?,?,?)";
